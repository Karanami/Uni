...
class Agent:
    def __init__(self, size, walls, loc, dir, eps_move, eps_perc):
        ...
        self.t = 0
        self.P = np.zeros(self.size, dtype=np.float64)
        # we start from 0
        self.P[loc[0]] = 1.0
    ...
    def predict_posterior(self, action):
        ...
        self.P = bel(self.eps_move, action, self.P)
    ...
    def correct_posterior(self, percept):
        ...
        self.P = correction(self.eps_perc, percept, self.P)
