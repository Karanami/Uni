...
/**
  ...
  * @retval None
  */
void gpioOn(LED_DIO_Handle_TypeDef* hled)
{
  gpioWrite(hled, LED_ON);
}
...
/**
  ...
  * @retval None
  */
void gpioOff(LED_DIO_Handle_TypeDef* hled)
{
  gpioWrite(hled, LED_OFF);
}
...
/**
  ...
  * @retval None
  */
void gpioToggle(LED_DIO_Handle_TypeDef* hled)
{
...
/**
  ...
  */
LED_DIO_State_TypeDef gpioRead(const LED_DIO_Handle_TypeDef* hled)
{
